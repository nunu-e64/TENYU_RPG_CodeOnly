...
public:
	...
	void Add(char _name[32], int _level, int _cost, int _time, trick_tag::targetType_tag::type _targetType, std::string _damageEffectName, std::vector<sideEffect_tag> sideEffectList);
	void Clear();
